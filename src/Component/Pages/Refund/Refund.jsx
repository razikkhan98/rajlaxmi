    ...
    <section>
      <div className="bg-custom-gradient-product">
        ...
        <div className="container pt-5 text-light-gray-color font-size-14 inter-font-family-500">
          ...
          <span className="text-dark">Refund Policy</span>
        </div>
      </div>
      <div className="background-color-light-grayish-yellow py-3">
        <div className="container">
          <div className="refund-head my-4">
            <h2>
              Once an order is confirmed, RAJLAKSHMI JAVIKS will not accept return or
          ...
          <div className="mt-4 mb-5 pb-5">
            <ul>
              <h5>In case of Return & Exchange</h5>
            ...
            <ul>
              ...
              <li>
              RAJLAKSHMI JAVIKS needs to be notified of damaged product within 2 days
            ...
            <ul>
              ...
              <li>
              RAJLAKSHMI JAVIKS needs to be notified of missing product within 2 days
                from delivery date via email to rajlaxmiorganicfoods@gmail.com
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
              RAJLAKSHMI JAVIKS needs to be notified of spoilage of product within 2
                days from delivery date via email to
